...
export const SliderBtn = ({ children, value, className, progressBarClass }) => {
  ...
  return (
    <button
      // expose active state for parent DOM logic & styling
      data-active={isActive}
      className={cn(
        // visual tweaks for active / inactive states
        `relative transition-all duration-300 transform ${isActive
          ? 'opacity-100 scale-100 z-20 shadow-xl'
